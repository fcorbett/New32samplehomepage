...
function Stars() {
  return (
    <div className="flex gap-[2px]">
      {[...Array(5)].map((_, i) => (
        <svg key={i} viewBox="0 0 24 24" width="13" height="13" fill="var(--pnw-clay-accent)">
...
function RatingCard() {
  ...
  return (
    <a
      ...
      aria-label={`Google reviews: ${google.rating} out of 5 from ${google.count} reviews`}
    ...
    >
      ...
      <span className="text-xs text-[var(--pnw-ink-soft)] tracking-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_280px] gap-10 md:gap-16 items-start">
            <div>
              <p className="font-semibold text-[var(--pnw-moss)] text-sm tracking-wide mb-6">
                <Link to={aboutTo} className="hover:text-[var(--pnw-clay)] transition-colors">
                  Welcome to new32
                </Link>
              </p>
